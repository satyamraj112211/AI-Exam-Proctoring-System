...
import { FaEnvelope, FaLock, FaArrowRight, FaSpinner, FaUserGraduate, FaCheck } from 'react-icons/fa';
...
const StudentLogin = () => {
  ...
  // If the student is already authenticated in this browser profile,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await studentAuthAPI.login(formData.email, formData.password);
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full mb-4">
              <FaUserGraduate className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            </div>
