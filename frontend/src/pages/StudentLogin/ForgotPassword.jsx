...
const ForgotPassword = ({ onBack }) => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const response = await studentAuthAPI.forgotPassword(email);
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const response = await studentAuthAPI.verifyResetOTP(email, otpString);
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await studentAuthAPI.resetPassword(resetToken, password, confirmPassword);
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {loading ? (
                    <>
          ...
          {step === 3 && (
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {loading ? (
                  <>
                    <FaSpinner className="animate-spin" />
